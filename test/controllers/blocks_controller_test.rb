...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post blocks_url, params: { block: { block_hash: @block.block_hash, height: @block.height } }
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { block_hash: @block.block_hash, height: @block.height } }
